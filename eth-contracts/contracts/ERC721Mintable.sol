...
contract Ownable {
    ...
    modifier onlyOwner {
        require(msg.sender == _owner, "Ownable: Only the owner can access this feature");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == msg.sender, "ERC721: Sender is not owner");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getName() returns (string memory name) {
        return _name;
    }

    function getSymbol() returns (string memory symbol) {
        return _symbol;
    }

    function getBaseTokenURI() returns(string memory baseTokenURI) {
...
contract CustomERC721Token is ERC721Metadata("ERC721 Token", "ERC721", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {

    function mint(address to, uint256 tokenId, string memory tokenURI) onlyOwner returns(bool) {
